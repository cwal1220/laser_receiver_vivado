...
-- Command     : write_vhdl -force -mode funcsim -rename_top laser_receiver_block_ad7606c_0_0 -prefix
--               laser_receiver_block_ad7606c_0_0_ laser_receiver_block_ad7606c_0_0_sim_netlist.vhdl
...
entity laser_receiver_block_ad7606c_0_0_ad7606c is
  port (
...
end laser_receiver_block_ad7606c_0_0_ad7606c;

architecture STRUCTURE of laser_receiver_block_ad7606c_0_0_ad7606c is
  ...
  attribute SOFT_HLUTNM of \_ch_sel[0]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \_ch_sel[1]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \_ch_sel[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \_out_data[3][7]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \_out_data[3][7]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of adc_rst_i_13 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of adc_rst_i_2 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of adc_rst_i_6 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of adc_rst_i_7 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of adc_rst_i_9 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_13\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \counter[0]_i_18\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter[0]_i_19\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter[0]_i_20\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter[0]_i_22\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \counter[0]_i_23\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \state[1]_i_6\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \state[2]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \state[31]_i_12\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \state[31]_i_16\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \state[31]_i_17\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \state[31]_i_8\ : label is "soft_lutpair9";
...
\_ch_sel[3]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\_ch_sel[3]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00005D0000005D5D"
    )
        port map (
      I0 => state(2),
      I1 => state(0),
...
\_ch_sel[3]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\_out_data[0][7]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\_out_data[3][7]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
adc_rst_i_12: unisim.vcomponents.LUT6
    generic map(
...
adc_rst_i_13: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
adc_rst_i_9: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
counter1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(3) => counter1_carry_i_2_n_0,
      DI(2) => counter1_carry_i_3_n_0,
      DI(1) => counter1_carry_i_4_n_0,
      DI(0) => counter1_carry_i_5_n_0,
      O(3 downto 0) => NLW_counter1_carry_O_UNCONNECTED(3 downto 0),
      S(3) => counter1_carry_i_6_n_0,
      S(2) => counter1_carry_i_7_n_0,
      S(1) => counter1_carry_i_8_n_0,
      S(0) => counter1_carry_i_9_n_0
    );
...
\counter1_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \counter1_carry__2_i_1_n_0\,
      DI(1) => \counter1_carry__2_i_2_n_0\,
      DI(0) => \counter1_carry__2_i_3_n_0\,
...
counter1_carry_i_9: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\counter[0]_i_17\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"70F0F0F0"
    )
        port map (
...
\counter[0]_i_19\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0F0FEFEE"
    )
        port map (
...
\state[31]_i_12\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000023"
    )
        port map (
...
\state[31]_i_16\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\state[31]_i_17\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity laser_receiver_block_ad7606c_0_0 is
  port (
    clk : in STD_LOGIC;
    start : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of laser_receiver_block_ad7606c_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of laser_receiver_block_ad7606c_0_0 : entity is "laser_receiver_block_ad7606c_0_0,ad7606c,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of laser_receiver_block_ad7606c_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of laser_receiver_block_ad7606c_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of laser_receiver_block_ad7606c_0_0 : entity is "ad7606c,Vivado 2022.2";
end laser_receiver_block_ad7606c_0_0;

architecture STRUCTURE of laser_receiver_block_ad7606c_0_0 is
...
inst: entity work.laser_receiver_block_ad7606c_0_0_ad7606c
     port map (
