...
--               d:/FPGA/workspace/laser_receiver_project/laser_receiver_project.gen/sources_1/bd/laser_receiver_block/ip/laser_receiver_block_ad7606c_0_0/laser_receiver_block_ad7606c_0_0_sim_netlist.vhdl
...
entity laser_receiver_block_ad7606c_0_0_ad7606c is
  ...
  attribute ORIG_REF_NAME of laser_receiver_block_ad7606c_0_0_ad7606c : entity is "ad7606c";
...
architecture STRUCTURE of laser_receiver_block_ad7606c_0_0_ad7606c is
  ...
  attribute SOFT_HLUTNM of \_ch_sel[0]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of adc_cs_i_2 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \register_mode_val[10]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \register_mode_val[6]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \register_mode_val[7]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \register_mode_val[9]_i_1\ : label is "soft_lutpair26";
  ...
  attribute SOFT_HLUTNM of \state[10]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \state[11]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[12]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[13]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \state[14]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \state[15]_i_1\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \state[18]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \state[19]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \state[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \state[1]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state[20]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \state[21]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \state[22]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \state[23]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \state[24]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \state[25]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \state[26]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \state[27]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \state[28]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \state[29]_i_1\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \state[30]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \state[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \state[4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \state[5]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[6]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[7]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[8]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[9]_i_1\ : label is "soft_lutpair15";
...
\register_mode_val[15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\register_mode_val[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
