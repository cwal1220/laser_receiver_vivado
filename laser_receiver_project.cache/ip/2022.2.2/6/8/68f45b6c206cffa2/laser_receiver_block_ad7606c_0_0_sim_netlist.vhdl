...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  signal \_out_data[1][15]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \_out_data[0][15]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \_out_data[0][15]_i_4\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \_out_data[3][15]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of active_i_1 : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of adc_rd_i_2 : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_14\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of led_i_2 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[31]_i_10\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[31]_i_14\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \state[31]_i_18\ : label is "soft_lutpair10";
...
\_out_data[0][15]_i_10\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\_out_data[0][15]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\_out_data[0][15]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\_out_data[0][15]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\_out_data[0][15]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00010000"
    )
        port map (
...
\_out_data[1][15]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\_out_data[3][15]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFDFFFF"
    )
        port map (
