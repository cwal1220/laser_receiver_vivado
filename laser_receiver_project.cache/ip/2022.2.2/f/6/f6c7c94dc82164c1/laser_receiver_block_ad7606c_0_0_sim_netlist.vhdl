...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  signal \delayStart[0]_i_6_n_0\ : STD_LOGIC;
  signal \delayStart[0]_i_7_n_0\ : STD_LOGIC;
  signal \delayStart[0]_i_8_n_0\ : STD_LOGIC;
  signal \delayStart[0]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \_ch_sel[2]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_4\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of adc_convst_i_2 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of adc_convst_i_4 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of adc_cs_i_10 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of adc_rst_i_6 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of adc_rst_i_7 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of adc_wr_i_10 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of adc_wr_i_5 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of adc_wr_i_6 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_17\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter[0]_i_18\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter[0]_i_19\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \counter[0]_i_20\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter[0]_i_21\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \counter[0]_i_4\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \delayStart[0]_i_7\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \delayStart[0]_i_9\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \state[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \state[2]_i_11\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \state[2]_i_12\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[2]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[2]_i_7\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state[2]_i_8\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[31]_i_10\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \state[31]_i_11\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \state[31]_i_12\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state[31]_i_13\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \state[31]_i_14\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \state[31]_i_15\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[31]_i_16\ : label is "soft_lutpair16";
...
begin
  ...
  adc_wr <= \^adc_wr\;
  busy <= \^busy\;
\_ch_sel[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF1000"
    )
        port map (
...
\_out_data[0][7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
\_out_data[1][7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\_out_data[2][7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
      ...
      I2 => \_ch_sel_reg_n_0_[0]\,
      O => \_out_data[2][7]_i_1_n_0\
    );
\_out_data[3][7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
adc_convst_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
adc_cs_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
adc_cs_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
adc_wr_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\counter[0]_i_16\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000405540554055"
    )
        port map (
      I0 => \delayStart[0]_i_7_n_0\,
      I1 => state(25),
      I2 => state(24),
      I3 => state(23),
      I4 => state(29),
...
\counter[0]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FFFFAAABAAAB"
    )
        port map (
      I0 => \counter[0]_i_17_n_0\,
      I1 => state(4),
      I2 => state(2),
      I3 => state(0),
      I4 => counter_reg(3),
...
\delayStart[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0100000000000001"
        ...
        port map (
      I0 => \delayStart[0]_i_6_n_0\,
      I1 => \delayStart[0]_i_7_n_0\,
...
\delayStart[0]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\delayStart[0]_i_5\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => state(20),
      I2 => state(19),
      I3 => \delayStart[0]_i_9_n_0\,
      I4 => \counter[0]_i_6_n_0\,
      O => \delayStart[0]_i_5_n_0\
    );
\delayStart[0]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7070FF70FF70FF70"
    )
        port map (
      ...
      I4 => state(24),
      I5 => state(25),
      O => \delayStart[0]_i_6_n_0\
    );
\delayStart[0]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2A"
    )
        port map (
      ...
      I1 => state(9),
      I2 => state(10),
      O => \delayStart[0]_i_7_n_0\
    );
\delayStart[0]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0507000005070007"
    )
        port map (
      I0 => state(4),
      I1 => state(3),
      ...
      I4 => state(1),
      I5 => start,
      O => \delayStart[0]_i_8_n_0\
    );
\delayStart[0]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"55555554"
    )
        port map (
...
\state[31]_i_12\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\state[31]_i_13\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\state[31]_i_18\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\state[31]_i_19\: unisim.vcomponents.LUT6
    generic map(
...
\state[31]_i_20\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
