...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  signal adc_db_reg : STD_LOGIC_VECTOR ( 10 downto 6 );
  ...
  attribute SOFT_HLUTNM of \_ch_sel[0]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \_ch_sel[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \_ch_sel[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_7\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_9\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of adc_convst_i_2 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of adc_convst_i_4 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of adc_cs_i_10 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of adc_cs_i_2 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of adc_cs_i_6 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \adc_db_reg[10]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \adc_db_reg[15]_i_5\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \adc_db_reg[6]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \adc_db_reg[9]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of adc_rd_i_2 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of adc_rst_i_10 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of adc_rst_i_8 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of adc_rst_i_9 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of adc_wr_i_4 : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_14\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \counter[0]_i_17\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \counter[0]_i_22\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \counter[0]_i_23\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \counter[0]_i_24\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter[0]_i_26\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter[0]_i_28\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \state[2]_i_10\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \state[2]_i_8\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \state[31]_i_11\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \state[31]_i_14\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \state[31]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \state[31]_i_5\ : label is "soft_lutpair11";
...
\_ch_sel[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\_out_data[0][7]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\_out_data[0][7]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BBFB"
    )
        port map (
...
\_out_data[0][7]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\_out_data[0][7]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\_out_data[0][7]_i_9\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\adc_db_reg[15]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\adc_db_reg[15]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
...
\adc_db_reg[15]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
adc_wr_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFFFFFFFFFF"
    )
        port map (
...
\counter[0]_i_22\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
\counter[0]_i_24\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"070007F0"
    )
        port map (
...
\counter[0]_i_26\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFF7F3F3"
    )
        port map (
...
\delayStart[0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\state[31]_i_11\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\state[31]_i_13\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
