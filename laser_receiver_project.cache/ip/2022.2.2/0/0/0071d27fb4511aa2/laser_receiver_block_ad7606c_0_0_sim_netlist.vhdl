...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  port (
    ...
    led : out STD_LOGIC;
    adc_db : inout STD_LOGIC_VECTOR ( 11 downto 0 );
    clk : in STD_LOGIC;
    start : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  signal \adc_db_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \adc_db_reg[1]_i_1_n_0\ : STD_LOGIC;
  signal \adc_db_reg[2]_i_1_n_0\ : STD_LOGIC;
  signal \adc_db_reg[3]_i_1_n_0\ : STD_LOGIC;
  signal \adc_db_reg[4]_i_1_n_0\ : STD_LOGIC;
  signal \adc_db_reg[5]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_4\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \_out_data[1][7]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \_out_data[1][7]_i_3\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of adc_rst_i_2 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \channel[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \channel[31]_i_4\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \state[4]_i_11\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \state[4]_i_13\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[4]_i_17\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \state[4]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \state[4]_i_5\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \state[4]_i_7\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \state[4]_i_8\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state[4]_i_9\ : label is "soft_lutpair3";
...
\_out_data[0][7]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\_out_data[1][7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \_out_data[1][7]_i_3_n_0\,
      I5 => \_out_data[0][7]_i_5_n_0\,
      O => \_out_data[1][7]_i_1_n_0\
    );
\_out_data[1][7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
      I0 => \_out_data[0][7]_i_3_n_0\,
      I1 => channel(0),
...
\_out_data[3][7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => adc_rst_i_2_n_0,
      I3 => \_out_data[1][7]_i_3_n_0\,
      I4 => g0_b0_i_1_n_0,
      I5 => state(0),
      O => \_out_data\
    );
\_out_data[3][7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\adc_db_reg[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => adc_db(0),
      I1 => state(1),
      O => \adc_db_reg[0]_i_1_n_0\
    );
\adc_db_reg[10]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFF444F4"
    )
        port map (
      I0 => \_out_data[1][7]_i_3_n_0\,
      I1 => adc_db(10),
      I2 => state(3),
      I3 => state(1),
      I4 => state(2),
...
\adc_db_reg[15]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"000B"
    )
        port map (
...
\adc_db_reg[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"4"
    )
        port map (
      I0 => \_out_data[1][7]_i_3_n_0\,
      I1 => adc_db(1),
      O => \adc_db_reg[1]_i_1_n_0\
    );
\adc_db_reg[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"4"
    )
        port map (
      I0 => \_out_data[1][7]_i_3_n_0\,
      I1 => adc_db(2),
      O => \adc_db_reg[2]_i_1_n_0\
    );
\adc_db_reg[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => adc_db(3),
      I1 => state(1),
      O => \adc_db_reg[3]_i_1_n_0\
    );
\adc_db_reg[4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => adc_db(4),
      I1 => state(1),
      O => \adc_db_reg[4]_i_1_n_0\
    );
\adc_db_reg[5]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"4"
    )
        port map (
...
\adc_db_reg[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FE03FF"
    )
        port map (
...
\adc_db_reg[9]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00FD"
    )
        port map (
...
\adc_db_reg_reg[1]\: unisim.vcomponents.FDSE
     port map (
      C => clk,
      CE => adc_db_reg,
      D => \adc_db_reg[1]_i_1_n_0\,
      Q => adc_db(1),
      S => \g0_b0__1_n_0\
    );
\adc_db_reg_reg[2]\: unisim.vcomponents.FDSE
     port map (
      C => clk,
      CE => adc_db_reg,
      D => \adc_db_reg[2]_i_1_n_0\,
      Q => adc_db(2),
      S => \g0_b0__1_n_0\
    );
...
\adc_db_reg_reg[4]\: unisim.vcomponents.FDSE
     port map (
      C => clk,
      CE => adc_db_reg,
      D => \adc_db_reg[4]_i_1_n_0\,
      Q => adc_db(4),
      S => \g0_b0__2_n_0\
    );
\adc_db_reg_reg[5]\: unisim.vcomponents.FDSE
     port map (
      C => clk,
      CE => adc_db_reg,
      D => \adc_db_reg[5]_i_1_n_0\,
      Q => adc_db(5),
      S => \g0_b0__1_n_0\
    );
\adc_db_reg_reg[6]\: unisim.vcomponents.FDSE
     port map (
      C => clk,
      CE => adc_db_reg,
      D => \adc_db_reg[6]_i_1_n_0\,
      Q => adc_db(6),
      S => \g0_b0__1_n_0\
    );
...
\channel[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00EF"
    )
        port map (
      I0 => \_out_data[3][7]_i_2_n_0\,
      I1 => \channel[31]_i_4_n_0\,
      I2 => channel(2),
      I3 => channel(0),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c
     port map (
      ...
      adc_cs => adc_cs,
      adc_db(11) => adc_db(15),
      adc_db(10 downto 0) => adc_db(10 downto 0),
      adc_rd => adc_rd,
      adc_rst => adc_rst,
      adc_wr => adc_wr,
      clk => clk,
