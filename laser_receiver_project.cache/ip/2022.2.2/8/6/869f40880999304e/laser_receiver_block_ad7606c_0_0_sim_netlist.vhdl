...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  attribute SOFT_HLUTNM of \adc_db_reg[15]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \adc_db_reg[8]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of adc_rd_i_2 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of adc_rd_i_3 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of adc_rd_i_4 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of adc_rst_i_2 : label is "soft_lutpair16";
...
\adc_db_reg[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00202020"
    )
        port map (
...
\adc_db_reg[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0200"
    )
        port map (
