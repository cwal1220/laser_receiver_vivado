...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  attribute SOFT_HLUTNM of \_ch_sel[1]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of adc_cs_i_12 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of adc_cs_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_cs_i_4 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of adc_cs_i_7 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of adc_rd_i_3 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of adc_rst_i_2 : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_5\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \delayStart[0]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \delayStart[0]_i_4\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \state[31]_i_9\ : label is "soft_lutpair3";
...
\delayStart[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => state(31),
      I2 => delayStart(0),
      I3 => \delayStart[0]_i_5_n_0\,
      I4 => \delayStart[0]_i_6_n_0\,
      I5 => \delayStart[0]_i_7_n_0\,
...
\delayStart[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFA8"
    )
        port map (
...
\delayStart[0]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
      ...
      I2 => state(12),
      I3 => state(13),
      I4 => \delayStart[0]_i_8_n_0\,
      O => \delayStart[0]_i_6_n_0\
    );
\delayStart[0]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\delayStart[0]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
