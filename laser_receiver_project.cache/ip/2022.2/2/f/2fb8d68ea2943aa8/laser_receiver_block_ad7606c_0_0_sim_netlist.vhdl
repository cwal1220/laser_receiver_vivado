...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  signal \counter__62\ : STD_LOGIC_VECTOR ( 8 to 8 );
  ...
  signal register_mode_val : STD_LOGIC_VECTOR ( 10 downto 7 );
  ...
  attribute SOFT_HLUTNM of \_ch_sel[0]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \_ch_sel[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \_ch_sel[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_4\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \_out_data[2][7]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \_out_data[3][7]_i_2\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of adc_convst_i_4 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of adc_cs_i_10 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of adc_cs_i_11 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of adc_cs_i_12 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of adc_cs_i_14 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of adc_cs_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of adc_cs_i_5 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of adc_cs_i_7 : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of adc_rd_i_6 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of adc_rd_i_7 : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_10\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \counter[0]_i_14\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \counter[0]_i_5\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter[4]_i_6\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \counter[4]_i_7\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter[8]_i_6\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \delayStart[0]_i_4\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \delayStart[0]_i_5\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \register_mode_val[10]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \register_mode_val[7]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \state[2]_i_9\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \state[31]_i_4\ : label is "soft_lutpair8";
...
\_out_data[0][7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
adc_cs_i_21: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
adc_rd_i_7: unisim.vcomponents.LUT3
    generic map(
      INIT => X"10"
    )
        port map (
...
\delayStart[0]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\register_mode_val[15]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"10000000"
    )
        port map (
