...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  signal \state_reg[31]_i_7_n_2\ : STD_LOGIC;
  signal \state_reg[31]_i_7_n_3\ : STD_LOGIC;
  signal \state_reg[31]_i_7_n_5\ : STD_LOGIC;
  signal \state_reg[31]_i_7_n_6\ : STD_LOGIC;
  signal \state_reg[31]_i_7_n_7\ : STD_LOGIC;
  ...
  signal \NLW_state_reg[31]_i_7_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_state_reg[31]_i_7_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \_ch_sel[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \_ch_sel[2]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of adc_cs_i_1 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of adc_wr_i_2 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_5\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \register_mode_val[10]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \register_mode_val[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \register_mode_val[7]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \state[31]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \state[31]_i_5\ : label is "soft_lutpair5";
  ...
  attribute ADDER_THRESHOLD of \state_reg[31]_i_7\ : label is 35;
...
\_out_data[3][7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2000"
    )
        port map (
...
adc_cs_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
adc_wr_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00800000"
    )
        port map (
...
\state_reg[31]_i_7\: unisim.vcomponents.CARRY4
     port map (
      CI => \state_reg[28]_i_2_n_0\,
      CO(3 downto 2) => \NLW_state_reg[31]_i_7_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \state_reg[31]_i_7_n_2\,
      CO(0) => \state_reg[31]_i_7_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_state_reg[31]_i_7_O_UNCONNECTED\(3),
      O(2) => \state_reg[31]_i_7_n_5\,
      O(1) => \state_reg[31]_i_7_n_6\,
      O(0) => \state_reg[31]_i_7_n_7\,
      S(3) => '0',
