...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, start, adc_db, adc_busy, adc_cs, adc_rd, 
  ...
  out_data2, out_data3, out_data4, led)
/* synthesis syn_black_box black_box_pad_pin="clk,start,adc_db[15:0],adc_busy,adc_cs,adc_rd,adc_convst,adc_rst,adc_sel,adc_os0,adc_os1,adc_os2,adc_wr,active,ch_sel[3:0],out_data1[15:0],out_data2[15:0],out_data3[15:0],out_data4[15:0],led" */;
  input clk;
  input start;
  inout [15:0]adc_db;
  input adc_busy;
