...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  attribute SOFT_HLUTNM of \_ch_sel[2]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \_ch_sel[2]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of adc_convst_i_2 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of adc_cs_i_10 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of adc_cs_i_11 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of adc_cs_i_15 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of adc_cs_i_16 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of adc_cs_i_19 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of adc_cs_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_cs_i_4 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of adc_rd_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_rd_i_3 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of adc_rd_i_5 : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of busy_i_5 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_9\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \counter[4]_i_7\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \state[0]_i_7\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \state[31]_i_4\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[31]_i_6\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[31]_i_7\ : label is "soft_lutpair14";
...
\_ch_sel[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEFF"
    )
        port map (
...
adc_rd_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"3002"
    )
        port map (
...
\counter[4]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000F5F50E0A0E0A"
    )
        port map (
      I0 => \counter[4]_i_7_n_0\,
      I1 => state(4),
      I2 => state(3),
      I3 => \counter[4]_i_8_n_0\,
      I4 => counter_reg(5),
      I5 => delayStart(0),
...
\state[31]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
