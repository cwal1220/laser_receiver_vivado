...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  signal \counter__65\ : STD_LOGIC_VECTOR ( 14 to 14 );
  ...
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_4\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \_out_data[1][7]_i_2\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of active_i_3 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of active_i_4 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of adc_convst_i_2 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of adc_convst_i_3 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of adc_cs_i_10 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of adc_cs_i_11 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of adc_cs_i_13 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of adc_cs_i_14 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of adc_cs_i_15 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of adc_cs_i_16 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of adc_cs_i_6 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \adc_db_reg[10]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \adc_db_reg[15]_i_4\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \adc_db_reg[6]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \adc_db_reg[7]_i_1\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of adc_rd_i_10 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of adc_rd_i_11 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of adc_rd_i_12 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of adc_rd_i_2 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of adc_rd_i_3 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of adc_rd_i_4 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of adc_rst_i_6 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of adc_rst_i_7 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of adc_rst_i_8 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of adc_wr_i_3 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_wr_i_4 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of adc_wr_i_8 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of adc_wr_i_9 : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_12\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \counter[0]_i_15\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \counter[0]_i_16\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter[0]_i_18\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \counter[0]_i_19\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \counter[0]_i_20\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter[0]_i_21\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter[0]_i_22\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter[0]_i_23\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of led_i_2 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \state[31]_i_4\ : label is "soft_lutpair18";
...
active_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
adc_convst_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"11100000"
    )
        port map (
...
adc_cs_i_11: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
adc_cs_i_17: unisim.vcomponents.LUT5
    generic map(
      INIT => X"5DDDEEEE"
    )
        port map (
...
adc_cs_i_18: unisim.vcomponents.LUT6
    generic map(
...
adc_rst_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
adc_rst_i_7: unisim.vcomponents.LUT5
    generic map(
      INIT => X"08000000"
    )
        port map (
...
adc_rst_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
adc_wr_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
adc_wr_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
adc_wr_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\counter[0]_i_16\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFE"
    )
        port map (
...
\counter[0]_i_18\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"04440044"
    )
        port map (
...
\counter[0]_i_20\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"11110CCC"
    )
        port map (
...
\counter[0]_i_21\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"020A0000"
    )
        port map (
...
\counter[0]_i_22\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFE"
    )
        port map (
