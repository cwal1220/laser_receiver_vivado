...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  signal adc_os0_i_1_n_0 : STD_LOGIC;
  signal adc_os0_i_2_n_0 : STD_LOGIC;
  signal \^adc_os1\ : STD_LOGIC;
  signal \^adc_os2\ : STD_LOGIC;
  signal adc_os2_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_4\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_5\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \_out_data[3][7]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of adc_convst_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_cs_i_11 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of adc_cs_i_12 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of adc_cs_i_13 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of adc_cs_i_14 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of adc_cs_i_15 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of adc_cs_i_16 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of adc_cs_i_3 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of adc_cs_i_4 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of adc_cs_i_7 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of adc_cs_i_8 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of adc_cs_i_9 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of adc_os0_i_2 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of adc_rd_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of adc_rd_i_3 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_rd_i_4 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of adc_rst_i_2 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of adc_rst_i_3 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of adc_rst_i_4 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of busy_i_4 : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_5\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \state[31]_i_10\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[31]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \state[31]_i_5\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \state[31]_i_7\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state[31]_i_8\ : label is "soft_lutpair3";
...
adc_cs_i_12: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
adc_cs_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
adc_os0_i_1: unisim.vcomponents.LUT6
    generic map(
...
adc_os0_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
adc_os2_i_1: unisim.vcomponents.LUT6
    generic map(
...
adc_os2_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
adc_rd_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
adc_rst_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000008"
    )
        port map (
...
\register_mode_val[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000800"
    )
        port map (
