...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  attribute SOFT_HLUTNM of \_ch_sel[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \_ch_sel[2]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of adc_convst_i_3 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_cs_i_18 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of adc_cs_i_4 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of adc_cs_i_5 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_cs_i_7 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of adc_rst_i_2 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \delayStart[0]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \delayStart[0]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \delayStart[0]_i_4\ : label is "soft_lutpair1";
...
adc_convst_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\delayStart[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000054"
    )
        port map (
