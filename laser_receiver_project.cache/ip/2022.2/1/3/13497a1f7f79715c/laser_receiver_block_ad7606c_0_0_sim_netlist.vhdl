...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  attribute SOFT_HLUTNM of \_ch_sel[1]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of adc_convst_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of adc_convst_i_2 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of adc_cs_i_11 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_cs_i_12 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of adc_cs_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of adc_cs_i_4 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of adc_cs_i_5 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of adc_cs_i_7 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of adc_rd_i_3 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of busy_i_2 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_10\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \delayStart[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \register_mode_val[10]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \register_mode_val[7]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \register_mode_val[9]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \state[31]_i_10\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \state[31]_i_4\ : label is "soft_lutpair4";
...
\_ch_sel[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
adc_cs_i_12: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
adc_cs_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\state[31]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
