...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  signal \_ch_sel1\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "MODE_WAIT:01,MODE_CONV:10,MODE_IDLE:00";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "MODE_WAIT:01,MODE_CONV:10,MODE_IDLE:00";
  attribute SOFT_HLUTNM of \_ch_sel[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \_ch_sel[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_3\ : label is "soft_lutpair1";
begin
...
\_ch_sel[3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\_ch_sel_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk,
      CE => \_ch_sel[3]_i_2_n_0\,
      D => \_ch_sel1\(0),
      Q => \^_ch_sel_reg[0]_0\,
      R => \_ch_sel[3]_i_1_n_0\
    );
