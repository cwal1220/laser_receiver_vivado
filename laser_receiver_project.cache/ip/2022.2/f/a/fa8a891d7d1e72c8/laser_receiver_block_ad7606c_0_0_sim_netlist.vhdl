...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  signal \_ch_sel[3]_i_10_n_0\ : STD_LOGIC;
  ...
  signal \_ch_sel[3]_i_5_n_0\ : STD_LOGIC;
  signal \_ch_sel[3]_i_6_n_0\ : STD_LOGIC;
  signal \_ch_sel[3]_i_7_n_0\ : STD_LOGIC;
  signal \_ch_sel[3]_i_8_n_0\ : STD_LOGIC;
  signal \_ch_sel[3]_i_9_n_0\ : STD_LOGIC;
  ...
  signal \register_mode_val[10]_i_1_n_0\ : STD_LOGIC;
  signal \register_mode_val[15]_i_1_n_0\ : STD_LOGIC;
  signal \register_mode_val[6]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_10\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_7\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_8\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \_ch_sel[3]_i_9\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \_out_data[0][7]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \_out_data[3][7]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of adc_convst_i_2 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of adc_convst_i_3 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of adc_cs_i_11 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_cs_i_13 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of adc_cs_i_14 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of adc_rd_i_2 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of adc_rd_i_4 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of adc_rd_i_5 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of adc_rd_i_6 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of adc_rd_i_8 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of adc_rd_i_9 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of adc_rst_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of adc_wr_i_2 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of adc_wr_i_3 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of busy_i_4 : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \delayStart[0]_i_3\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \register_mode_val[10]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[2]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state[31]_i_4\ : label is "soft_lutpair9";
...
\_ch_sel[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => state(31),
      I3 => \_ch_sel[3]_i_4_n_0\,
      I4 => \_ch_sel[3]_i_5_n_0\,
      I5 => \_ch_sel[3]_i_6_n_0\,
      O => \_ch_sel[3]_i_1_n_0\
    );
\_ch_sel[3]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\_ch_sel[3]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      ...
      I2 => state(17),
      I3 => state(18),
      I4 => \_ch_sel[3]_i_7_n_0\,
      O => \_ch_sel[3]_i_4_n_0\
    );
\_ch_sel[3]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      ...
      I2 => state(9),
      I3 => state(10),
      I4 => \_ch_sel[3]_i_8_n_0\,
      O => \_ch_sel[3]_i_5_n_0\
    );
\_ch_sel[3]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      I0 => \_ch_sel[3]_i_9_n_0\,
      I1 => state(26),
      I2 => state(25),
      I3 => state(28),
      I4 => state(27),
      I5 => \_ch_sel[3]_i_10_n_0\,
      O => \_ch_sel[3]_i_6_n_0\
    );
\_ch_sel[3]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => state(24),
      I3 => state(23),
      O => \_ch_sel[3]_i_7_n_0\
    );
\_ch_sel[3]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => state(16),
      I3 => state(15),
      O => \_ch_sel[3]_i_8_n_0\
    );
\_ch_sel[3]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\_out_data[0][7]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
adc_convst_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \_ch_sel[3]_i_6_n_0\,
      I1 => \_ch_sel[3]_i_5_n_0\,
...
adc_cs_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
adc_cs_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00030002"
        ...
        port map (
      I0 => adc_cs_i_9_n_0,
      I1 => \_ch_sel[3]_i_4_n_0\,
      I2 => \_ch_sel[3]_i_5_n_0\,
      I3 => \_ch_sel[3]_i_6_n_0\,
      I4 => adc_cs_i_10_n_0,
      O => adc_cs_i_5_n_0
    );
...
adc_rd_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \_ch_sel[3]_i_8_n_0\,
      I1 => adc_rd_i_8_n_0,
      I2 => \_ch_sel[3]_i_7_n_0\,
      I3 => adc_rd_i_9_n_0,
      O => adc_rd_i_7_n_0
    );
adc_rd_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
adc_rd_i_9: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
adc_wr_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\delayStart[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000200000000"
        ...
        port map (
      I0 => \delayStart[0]_i_3_n_0\,
      I1 => \_ch_sel[3]_i_6_n_0\,
      I2 => \_ch_sel[3]_i_5_n_0\,
      I3 => \_ch_sel[3]_i_4_n_0\,
      I4 => state(31),
      I5 => adc_convst_i_3_n_0,
      O => \delayStart[0]_i_2_n_0\
    );
\delayStart[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\register_mode_val[10]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\register_mode_val[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\register_mode_val[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
