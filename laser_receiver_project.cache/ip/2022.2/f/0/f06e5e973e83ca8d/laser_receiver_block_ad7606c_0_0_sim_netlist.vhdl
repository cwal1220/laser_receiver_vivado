...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad7606c is
  ...
  attribute SOFT_HLUTNM of \_ch_sel[0]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of adc_cs_i_2 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of adc_rd_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of adc_rd_i_8 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of adc_rst_i_2 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of adc_rst_i_3 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of adc_wr_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of adc_wr_i_7 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_4\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \delayStart[0]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \state[10]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[11]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[12]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[13]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \state[14]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \state[15]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[16]_i_1\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \state[19]_i_1\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \state[21]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \state[22]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \state[23]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \state[24]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \state[25]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \state[26]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \state[27]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \state[28]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \state[29]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \state[2]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state[30]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \state[31]_i_6\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \state[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \state[4]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \state[5]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \state[6]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \state[7]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \state[8]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \state[9]_i_1\ : label is "soft_lutpair13";
...
begin
  ...
  adc_wr <= \^adc_wr\;
  busy <= \^busy\;
\_ch_sel[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
adc_rd_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
