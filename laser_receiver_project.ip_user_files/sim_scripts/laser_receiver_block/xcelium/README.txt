...
#
# Generated by export_simulation on Sat May 20 11:13:40 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './laser_receiver_block.sh' script.

./laser_receiver_block.sh -reset_run
...
./laser_receiver_block.sh -noclean_files

For more information on the script, please type './laser_receiver_block.sh -help'.
