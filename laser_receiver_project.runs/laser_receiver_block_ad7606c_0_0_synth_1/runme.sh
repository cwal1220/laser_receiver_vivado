...
HD_PWD='D:/FPGA/workspace/laser_receiver_project/laser_receiver_project.runs/laser_receiver_block_ad7606c_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log laser_receiver_block_ad7606c_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source laser_receiver_block_ad7606c_0_0.tcl
