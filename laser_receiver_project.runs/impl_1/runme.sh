...
HD_PWD='D:/FPGA/workspace/laser_receiver_project/laser_receiver_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log laser_receiver_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source laser_receiver_block_wrapper.tcl -notrace
