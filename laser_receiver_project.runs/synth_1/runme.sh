...
HD_PWD='D:/FPGA/workspace/laser_receiver_project/laser_receiver_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log laser_receiver_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source laser_receiver_block_wrapper.tcl
